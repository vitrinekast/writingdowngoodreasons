...
<template>
    <Page type="fit">
        <div class="grid">
            ...
            <Frame class="cell--w-3" mask='ch-1-p-1_frame_5b-3' outline="ch-1-p-1_frame_5b-3" @mouseover="showBirdAway = true"
                @mouseleave="showBirdAway = false" type="hoverable">
                <img loading='lazy' src="@assets/ch-1-p-1_frame_5b-3/frame_asset.png" alt="" class="frame__asset">

                <Transition name="fade-asset">
                    <img loading='lazy' src="@assets/ch-1-p-1_frame_5b-3/frame-3--asset-step2.png" alt=""
                        v-if="showBirdAway" class="frame__asset--hover">
                </Transition>
            </Frame>

            <Frame class="cell cell--w-4 " mask='ch-1-p-1_frame_5b-4' outline="ch-1-p-1_frame_5b-4">
                <img loading='lazy' src="@assets/ch-1-p-1_frame_5b-4/frame_asset.png" alt="" class="frame__asset-text">
            </Frame>

            <Frame class=" cell--w-2 " mask='ch-1-p-1_frame_5b-5' outline="ch-1-p-1_frame_5b-5">
                <img loading='lazy' src="@assets/ch-1-p-1_frame_5b-5/frame_asset.png" alt="" class="frame__asset">
            </Frame>
