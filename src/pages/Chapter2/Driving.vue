...
<template>
	<main>
		<Page
			type="fixed"
			:style="`--posX: ${posX}; --posY: ${posY}; --rotate: ${rotate}`"
		>
			<img
				class="frame__asset frame__background"
				src="@assets/ch-2/driving/forestscape_driving.webp"
				alt=""
			/>
			<div class="overlay"></div>
			<div class="van__wrapper">
				<img
					class="frame__asset frame__van"
					src="@assets/ch-2/driving/van.webp"
					alt=""
				/>
			</div>
			<img
				class="frame__asset frame__dashboard"
				src="@assets/ch-2/driving/dashboard.webp"
				alt=""
			/>
		</Page>
	</main>
